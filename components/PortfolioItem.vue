<template>
    <div class="grid grid-cols-12 project py-12 md:py-10">
        ...
        <div class="image col-span-12 lg:col-span-6 order-1 lg:order-2 cursor-pointer" @click="openGallery">
            <NuxtImg height="400" width="750" class="h-[400px] w-full" preload  placeholder="https://placehold.co/750x400/161A29/546192?text=Loading..." :style="{ boxShadow: getBoxShadow(item.primaryColor) }" v-if="item?.screenShots[0]"
