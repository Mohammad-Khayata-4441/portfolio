            ...
            <section class="min-h-[80vh]   lg:flex">
                <div class="flex flex-col justify-center w-full p-8   lg:px-12 xl:px-32 lg:w-1/2">
                    ...
                    <div class="mt-6 md:mt-8">
                        ...
                        <h3 class="font-medium text-gray-600 mt-4 text-xl dark:text-white ">
                            Contact info </h3>
                        ...
                        <h3 class="font-medium text-gray-600 mt-8 text-xl dark:text-white ">
                            Social Media </h3>
                        <hr class="border-text">
                ...
                <div class="flex flex-col justify-center w-full p-8 pt-0 lg:w-1/2 lg:px-12 xl:px-24 ">
                    <form>
                        <div class="-mx-2 md:items-center md:flex">
                            <div class="flex-1 px-2">
                                ...
                                <input type="text" placeholder="John Doe"
                                    class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-full dark:placeholder-gray-600 dark:bg-dark-surface dark:bg-opacity-60 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
                        ...
                        <div class="w-full mt-4">
                            ...
                            <textarea
                                class="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-4xl md:h-56 dark:placeholder-gray-600 dark:bg-dark-surface dark:bg-opacity-60 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                                placeholder="Message"></textarea>
                        </div>

                        <button
                            class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-primary rounded-full hover:bg-primary focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                            get in touch
                        </button>
                    </form>
                </div>
